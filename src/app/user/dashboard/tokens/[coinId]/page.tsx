...
const HighLowIndicator = ({ currentPrice, high, low }: any) => {
  ...
  return (
    <div className="flex items-center w-full">
      <span
        className="bg-red-600 h-2 rounded-l-lg"
        style={{ width: `${100 - green}%` }}
      >
        &nbsp;
      </span>
      <span
        className="bg-green-600 h-2 rounded-r-lg"
        style={{ width: `${green}%` }}
      >
        &nbsp;
      </span>
...
const CryptoDetails = ({ params }: { params: { coinId: string } }) => {
  ...
  return (
    <div className="bg-gray-900 text-white p-6">
      <div className="w-full max-w-7xl bg-gray-800 rounded-lg overflow-hidden relative">
        {data ? (
          <div className="flex flex-col lg:flex-row h-full">
            <div className="lg:w-1/2 p-6 flex flex-col justify-between bg-gray-900">
            ...
            <div className="lg:w-1/2 p-6 flex flex-col bg-gray-900">
